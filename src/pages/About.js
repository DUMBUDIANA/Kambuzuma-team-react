    ...
    return (
        <div className="about-page-container">
            ...
            <div className="about-page-content">
                ...
                <p className="about-p">(Hitch costs extra 😉)</p>
                <br/>

                <p className="about-p">Our team is full of vanlife enthusiasts who know firsthand the magic of touring the world on 4 wheels.</p>
            </div>
